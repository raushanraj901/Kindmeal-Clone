import { navbar, selectmenu } from "./navbar.js";
...
productContainer.addEventListener("click", function () {
  let obj = {
    ...
    location:
      "31, Jalan SS21/56B, Damansara Utama , 47400 Petaling Jaya, Selangor.Opens: Mon - Sun: 11am - 3pm; 5.30pm - 10pmTel: 03-7497 6356 / 017-573 9796 / 012-3833 996",
    terms_and_conditions:
      "Coupon Validity	Must use coupon by Jun 22nd, 2022 Exclusivity	Valid with other KindMeal.my coupons only Reservation	Not required Repeat Customers	You can get this coupon once per week Dining Terms No Service Charge & SST Discount is applicable on weekdays (Mon - Fri) only Discount is not applicable for set lunch and promotional items",
    rating: "(58 Votes)",
  };
...
let select_navbar = (document.getElementById("select_navbar").innerHTML =
  selectmenu());
