var mockapi = [
  {
    ...
    back: "https://www.kindmeal.my/photos/deal/7/717-5054-l.jpg",
    expiry: "12 Days",
    votes: 11,
    rating: 5,
    discount: 20,
...
backimgs = [
  "https://www.kindmeal.my/photos/shop/1/195-c.jpg",
  "https://www.kindmeal.my/photos/shop/5/547-c.jpg",
  "https://www.kindmeal.my/photos/shop/1/195-c.jpg",
  "https://www.kindmeal.my/photos/shop/3/397-c.jpg",
  "https://www.kindmeal.my/photos/shop/5/545-c.jpg",
];
function load_secondpage() {
  ...
  document.getElementById(
    "placeholder_ex"
  ).innerHTML = `<div id="extop" style="background-image: url(${backimgs[ran]});border-radius:5px;">
    <div class="inline">
         <div id="extimg-box">
    ...
    <div class="flexbox" id="textbox2_ex">
     <h2>Location</h2>
     <p>2A, Jalan 21/19A, Seapark, 46300 Petaling Jaya, Selangor.
     Opens: Tue - Fri: 12pm - 10pm; Sat - Sun: 9am - 10pm; Mon: Closed
     Tel: 010-2727378.<br/>Opens: Daily: 11am - 10pm <br/>
        ...
        <table>
            <tr>
                ...
                <td>Must use coupon by jun 19th, 2022</td>
            </tr>
            <tr>
...
function starRating(i) {
  ...
  document.querySelector(`.star${i} .stars-inner`).style.width =
